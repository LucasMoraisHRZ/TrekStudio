...
entregamos uma identidade visual de alto impacto, com estratégia, estética e performance. Seja para lançar um produto, profissionalizar sua marca ou vender mais online.</p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-start">
            <div className="relative group">
              ...
              <Button onClick={handleContactClick} className="relative bg-[#131313] text-white font-inter font-bold py-6 px-8 rounded-md uppercase tracking-wide hover:bg-[#05E091] hover:text-black hover:shadow-[0_0_15px_rgba(5,224,145,0.6)] transition-all duration-300">
                FALE CONOSCO!
              </Button>
            </div>
...
seu negócio</div>
          ...
          <div className="pt-4 flex flex-col items-start">
            ...
            <p className="mt-2 text-sm text-[#faff74] font-inter font-medium">
              +200 Empreendedores já estão lucrando<br />
              com nossas estratégias de Design!
            </p>
            {isMobile && (
              <div className="mt-3">
                <img src="/lovable-uploads/f9a42c14-0d97-406b-92f6-4bbb50648f61.png" alt="Selo de qualidade" className="h-24 w-auto" />
              </div>
            )}
          </div>
        </div>
